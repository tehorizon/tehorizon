...
export const selectKeyValidationData = createSelector(
  [selectTest],
  (appReducer) => appReducer.keyValidationData
);
...
export const selectDeeplinkData = createSelector(
  [selectTest],
  (appReducer) => appReducer.deeplinkData
);
