...
class AppboyProject extends Component {
  constructor(props) {
    ...
    this._setSubscriptionStatePress =
      this._setSubscriptionStatePress.bind(this);
    ...
    this._unsetCustomUserAttributePress =
      this._unsetCustomUserAttributePress.bind(this);
    this._addToCustomAttributeArrayPress =
      this._addToCustomAttributeArrayPress.bind(this);
    this._removeFromCustomAttributeArrayPress =
      this._removeFromCustomAttributeArrayPress.bind(this);
    this._incrementCustomAttributePress =
      this._incrementCustomAttributePress.bind(this);
    ...
    this._requestImmediateDataFlush =
      this._requestImmediateDataFlush.bind(this);
    ...
    this._requestLocationInitialization =
      this._requestLocationInitialization.bind(this);
    this._requestGeofences = this._requestGeofences.bind(this);
    this._setLocationCustomAttribute =
      this._setLocationCustomAttribute.bind(this);
    this._setGenderPress = this._setGenderPress.bind(this);
    this._requestContentCardsRefresh =
      this._requestContentCardsRefresh.bind(this);
  ...
  _handleOpenUrl(event) {
    Alert.alert("Deep Link", event.url, [{ text: "OK", onPress: () => {} }]);
  }
    ...
    return (
      ...
      >
        ...
        <View style={styles.row}>
          <TextInput
            style={styles.textInput}
            onChangeText={(customEventText) =>
              this.setState({ customEventText })
            }
          />
        ...
        <View style={styles.row}>
          <Picker
            ...
            onValueChange={(value) =>
              this.setState({ subscriptionState: value })
            }
          >
  ...
  _logUserPropertiesPress(event) {
    ...
    ReactAppboy.setEmail("testiqbal@gmail.com");
  ...
  _enableSDK(event) {
    console.log("register app boy in src/appboyproject");
