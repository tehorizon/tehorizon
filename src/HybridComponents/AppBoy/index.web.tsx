...
import { AppboyEndPoint } from "@fast_track/src/AppConfig.json";
...
const initialize = () => {
  // const key = JniKeys.getKey('APP_BOY_API_KEY_WEB');

  const initialized = appboy.initialize(JniKeys.getKey("APP_BOY_API_KEY_WEB"), {
    baseUrl: AppboyEndPoint,
    enableLogging: true,
    serviceWorkerLocation: "/service-worker.js",
    inAppMessageZIndex: 91,
  });
